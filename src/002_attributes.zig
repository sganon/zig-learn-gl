...
const shd = @import("shaders/002_attributes.glsl.zig");
...
export fn init() void {
    ...
    state.bind.vertex_buffers[0] = sg.makeBuffer(.{ .data = sg.asRange(&[_]f32{
        ...
        0.5,  0.8,  0.0, 1.0, 0.0, 0.0, 1.0,
        0.5,  0.2,  0.0, 0.0, 1.0, 0.0, 1.0,
        0.9,  0.2,  0.0, 0.0, 0.0, 1.0, 1.0,
    }) });
...
export fn frame() void {
    ...
    sg.applyUniforms(shd.UB_fs_params, sg.asRange(&shd.FsParams{ .ourColor = [4]f32{ 0.0, @floatCast(green_value), 0.0, 1.0 } }));
